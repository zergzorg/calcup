...
- 58 готовых калькуляторов.
- 16 запланированных `soon`-карточек для расширения каталога.
...
- `/finance/` — кредит, ипотека, вклад, сложный процент, НДС, зарплата, стоимость проекта.
