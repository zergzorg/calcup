...
- 33 готовых калькулятора.
- 41 запланированная `soon`-карточка для расширения каталога.
...
- `/construction/` — обои, краска, плитка, ламинат, стяжка пола, кирпич, газоблок, гипсокартон, шпатлёвка, утеплитель.
- `/transport/` — расход топлива, стоимость поездки, цена топлива, средняя скорость.
