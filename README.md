...
- 19 готовых калькуляторов.
- 55 запланированных `soon`-карточек для расширения каталога.
...
- `/sport/` — темп, скорость, дистанция и время бега.
- `/datetime/` — разница между датами.
- `/everyday/` — чаевые, скидка, выгодная покупка.

Новое направление `/sport/` уже открыто первым готовым калькулятором темпа и скорости. `/clothing/` пока добавлено в навигацию и реестр как дорожная карта с `soon`-инструментами.
