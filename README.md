...
- 53 готовых калькулятора.
- 21 запланированная `soon`-карточка для расширения каталога.
...
- `/math/` — проценты, дроби, среднее значение, пропорции и уравнения.
- `/health/` — ИМТ.
- `/convert/` — длина, температура, вес, площадь, объём, скорость и объём данных.
...
- `/everyday/` — чаевые, разделение счёта, скидка, выгодная покупка, площадь комнаты, электроэнергия и кухонные меры.
...
- `/math/fraction/` — сложение, вычитание, умножение, деление и сокращение дробей.
- `/math/average/` — среднее, медиана, сумма, минимум и максимум.
- `/math/proportion/` — пропорции, отношение и правило трёх.
- `/math/equation/` — линейные и квадратные уравнения.
...
- `/convert/data-size/` — байты, KB/MB/GB/TB и KiB/MiB/GiB/TiB.
...
- `/everyday/room-area/` — площадь пола, потолка и стен комнаты.
- `/everyday/electricity/` — расход кВт⋅ч и стоимость работы прибора.
- `/everyday/cooking-units/` — ложки, чашки, миллилитры и литры для рецептов.
