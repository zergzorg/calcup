...
- 48 готовых калькуляторов.
- 26 запланированных `soon`-карточек для расширения каталога.
...
- `/everyday/` — чаевые, разделение счёта, скидка, выгодная покупка, площадь комнаты и электроэнергия.
