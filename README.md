...
- 70 готовых калькуляторов.
- 10 запланированных `soon`-карточек для расширения каталога.
...
- `/construction/` — обои, краска, плитка, ламинат, стяжка пола, кирпич, газоблок, гипсокартон, шпатлёвка, утеплитель, бетон, ленточный фундамент, плитный фундамент, арматура и кровля.
