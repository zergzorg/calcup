...
- 69 готовых калькуляторов.
- 11 запланированных `soon`-карточек для расширения каталога.
...
- `/construction/` — обои, краска, плитка, ламинат, стяжка пола, кирпич, газоблок, гипсокартон, шпатлёвка, утеплитель, бетон, ленточный фундамент, плитный фундамент и арматура.
