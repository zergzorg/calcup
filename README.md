...
- 31 готовый калькулятор.
- 43 запланированных `soon`-карточки для расширения каталога.
...
- `/construction/` — обои, краска, плитка, ламинат, стяжка пола, кирпич, газоблок, гипсокартон.
