...
- 47 готовых калькуляторов.
- 27 запланированных `soon`-карточек для расширения каталога.
...
- `/everyday/` — чаевые, разделение счёта, скидка, выгодная покупка и площадь комнаты.
