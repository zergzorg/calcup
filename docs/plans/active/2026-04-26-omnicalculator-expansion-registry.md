...
На 2026-04-26 в `src/data/calculators.ts` есть 11 категорий и 71 ready-калькулятор. Уже закрыты базовые финансы, математика, здоровье, конвертеры, строительство, транспорт, спорт, животные, одежда, даты и быт.
