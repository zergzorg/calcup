...
На 2026-04-26 в `src/data/calculators.ts` есть 11 категорий и 70 ready-калькуляторов. Уже закрыты базовые финансы, математика, здоровье, конвертеры, строительство, транспорт, спорт, животные, одежда, даты и быт.
